        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.makeRequestAsync(() => {
                ...
                if (!qNode.isQualified() && qNode.isRoot()) {
                    ...
                    if (resolved != null) {
                        (_d = this.logger) === null || _d === void 0 ? void 0 : _d.log(ember_client_logs_1.ClientLogs.GETDIRECTORY_RESPONSE(resolved));
                        if (resolved.isStream && resolved.isStream()) {
                            const streamIdentifier = resolved.streamIdentifier;
